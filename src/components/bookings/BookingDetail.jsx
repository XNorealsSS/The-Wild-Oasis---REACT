...
export default function BookingDetail() {
  ...
  return (
    <>
      <Row type="horizontal">
        <HeadingGroup>
          <Heading as="h1" className="max-[450px]:text-3xl!">
            Booking #{bookingId}
          </Heading>
          <Tag
      ...
      <ButtonGroup>
        ...
        {status === "checked-in" && (
          <Button
            icon={<HiMiniArrowUpOnSquareStack />}
        ...
        <Modal>
          ...
          <Modal.Window name="delete" size="smallModal">
            <ConfirmDelete
              resourceName="booking"
              onConfirm={() =>
                deleteBooking(bookingId, {
                  onSettled: () => navigate("/bookings"), // ⏺ onSettled is a React Query method/function, it'll always happen no matter it's an error or a success
                })
              }
              disabled={isDeleting}
            />
